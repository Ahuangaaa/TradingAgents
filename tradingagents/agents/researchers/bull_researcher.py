...
- News Timeliness (moderate): In each round, explicitly assess news recency and impact (prefer 1-3 items within ~30 days). If a key news signal is stale/ambiguous, state that it is down-weighted and rely more on market/fundamental evidence.
...
Deep fundamental checklist (structured, covers products, operations, industry, management, regulatory — use explicitly): {deep_checklist}
