...
- For **股东户数** signals, apply a combined timing-and-variance rule: if the latest holder-count change is **highly recent** (e.g. latest disclosure within ~2 months) and the report-period series shows **large average fluctuation** or **large one-direction move** (especially sustained increase), assign **high risk weight**; note **筹码分散** and—in context of prior strength or elevated prices—**possible 主力出货**. If average fluctuation is small or disclosures are stale/far from current date, do **not** assign overly high weight to holder-count evidence alone.
